...
public class questionActivity5 extends AppCompatActivity implements View.OnClickListener {
    ...
    public void addQuestion(TextView question,Button answer){
        ...
        mFirebaseMethods.addAnotherQuestion(question.getText().toString(),answer.getText().toString(),questionCount,5);

    }

    public void goToQuestionActivity6(){
