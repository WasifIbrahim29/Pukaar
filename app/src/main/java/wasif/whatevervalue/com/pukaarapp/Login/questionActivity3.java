...
public class questionActivity3 extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String TAG = "questionActivity3";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mFirebaseMethods= new FirebaseMethods(questionActivity3.this);
    ...
    public void addQuestion(TextView question,Button answer){
        ...
        mFirebaseMethods.addAnotherQuestion(question.getText().toString(),answer.getText().toString(),questionCount,3);

    }

    public void goToQuestionActivity4(){
