...
public class verifyNumberActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mContext = verifyNumberActivity.this;
        ...
        findViewById(R.id.verifyNumber).setOnClickListener(this);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            firebaseMethods.registerNewEmail(email,password,nickname,"none",phoneNumber,"none",questionCount,"firstTime",questionCount);
                            mAuth.signOut();
                            goToLoginActicity();
                            // [END_EXCLUDE]
                        } else {
    ...
    public void goToLoginActicity(){
        Toast.makeText(this,"Your phone number is verified",Toast.LENGTH_SHORT).show();
